...
# find the atomic number of a given element
def get_atomic_number(element):
    ...
    ----------
    element : str
        The element to find the atomic number of.
...
# find the element of a given atomic number
def get_element(atomic_number):
    ...
    ----------
    atomic_number : int
        The atomic number of the element to find.

    Returns
    -------
    element : str
        The element of the atomic number.

    """
    for (symbol, atomic_number2) in elements:
        if atomic_number == atomic_number2:
            return symbol
    return None

print(get_atomic_number("Rb"))
print(get_element(37))
